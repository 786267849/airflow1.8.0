...
from airflow.jollychic.hooks.jolly_spark_sql_hook import JollySparkSqlHook


class JollySparkSqlOperator(JollyBaseOperator):
    """
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(JollySparkSqlOperator, self).__init__(*args, **kwargs)
        self._sql = sql
        self._conf = conf
