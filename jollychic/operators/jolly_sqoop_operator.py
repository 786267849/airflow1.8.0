...
from airflow.jollychic.hooks.jolly_sqoop_hook import JollySqoopHook


class JollySqoopOperator(JollyBaseOperator):
    """
    Execute a Sqoop job.
    ...
    def __init__(self,
        ...
        :param input_null_string: The string to be interpreted as null for string columns
        :param input_null_non_string: The string to be interpreted as null for non-string columns
        ...
        :param extra_export_options: Extra export options to pass as dict.
            ...
            Don't include prefix of -- for sqoop options.
        """
        super(JollySqoopOperator, self).__init__(*args, **kwargs)
