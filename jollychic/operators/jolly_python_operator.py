...
from airflow.models import JollyBaseOperator, TaskInstance
from airflow.utils.state import State
from airflow.utils.decorators import apply_defaults
from airflow import settings


class JollyPythonOperator(JollyBaseOperator):
    """
    ...
    def __init__(
            ...
            templates_exts=None,
            *args, **kwargs):
        super(JollyPythonOperator, self).__init__(*args, **kwargs)
